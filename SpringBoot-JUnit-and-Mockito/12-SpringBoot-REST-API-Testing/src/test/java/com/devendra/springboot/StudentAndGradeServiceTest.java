...
import com.devendra.springboot.models.*;
...
public class StudentAndGradeServiceTest {
    ...
    public void isStudentNullCheck() {
        ...
        assertTrue(studentAndGradeService.checkIfStudentExist(1), "@BeforeTransaction creates student : return true");

        assertFalse(studentAndGradeService.checkIfStudentExist(0), "No student should have 0 id : return false");
    }
    ...
    public void isGradeNullCheck() {
        ...
        assertTrue(studentAndGradeService.checkIfGradeIsNull(1, "math"),
                "@BeforeTransaction creates student : return true");

        assertTrue(studentAndGradeService.checkIfGradeIsNull(1, "science"),
                "@BeforeTransaction creates student : return true");

        assertTrue(studentAndGradeService.checkIfGradeIsNull(1, "history"),
                "@BeforeTransaction creates student : return true");

        assertFalse(studentAndGradeService.checkIfGradeIsNull(0, "science"),
                "No student should have 0 id : return false");

        assertFalse(studentAndGradeService.checkIfGradeIsNull(0, "Literature"),
                "No student should have 0 id : return false");
    }
